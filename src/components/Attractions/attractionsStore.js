...
// Demo data for attractions store
const getCurrentDataByType = (type) => {
  const demoData = {
    attractions: [
      { id: 1, name: 'Demo Attraction 1', image: 'https://via.placeholder.com/300x200' },
      { id: 2, name: 'Demo Attraction 2', image: 'https://via.placeholder.com/300x200' }
    ]
  };
