...
// Demo data for facilities store
const getCurrentDataByType = (type) => {
  const demoData = {
    facilities: [
      { id: 1, name: 'Demo Facility 1', description: 'Demo facility description' },
      { id: 2, name: 'Demo Facility 2', description: 'Demo facility description' }
    ]
  };
