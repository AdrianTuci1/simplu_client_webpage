...
// Demo data for services store
const getCurrentDataByType = (type) => {
  const demoData = {
    services: [
      { id: 1, name: 'Demo Service 1', description: 'Demo service description' },
      { id: 2, name: 'Demo Service 2', description: 'Demo service description' }
    ]
  };
